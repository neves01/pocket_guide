...
public class RdsStack extends Stack {
    ...
    public RdsStack(final Construct scope, final String id, final StackProps props, Vpc vpc) {
        ...
        iSecurityGroup.addIngressRule(Peer.anyIpv4(), Port.tcp(3306)); // any internet ip can access the database through port 3306
        ...
        DatabaseInstance databaseInstance = DatabaseInstance.Builder
                ...
                .multiAz(false) // disable availability zones
                .allocatedStorage(10)
                .securityGroups(Collections.singletonList(iSecurityGroup))
                .vpcSubnets(SubnetSelection.builder() // same subnet from vpc
